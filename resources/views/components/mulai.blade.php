        ...
        <div class="relative w-full max-w-[1680px] rounded-3xl overflow-hidden shadow-2xl" style="background: linear-gradient(135deg, #082265, #1a4fa8);">
            ...
            <div class="relative z-10 flex flex-col items-center text-center px-8 py-20 md:px-24">
                ...
                <p class="text-white/75 text-sm md:text-lg leading-8 mb-10">
                    Jangan biarkan kurangnya peralatan menghalangi Anda untuk melihat dunia dari ketinggian.<br>
                    Konsultasikan rencana pendakian Anda dengan tim ahli kami secara gratis.
                </p>
                <a href="https://wa.me/6281234567890" target="_blank"
                   class="flex items-center gap-2 bg-kuning text-surface-dark font-semibold px-6 py-3 rounded-full shadow-lg hover:brightness-110 transition">
