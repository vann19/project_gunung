<x-layouts.app title="Pembayaran Open Trip - {{ config('app.name') }}" description="Pembayaran layanan Open Trip gunung.">
        ...
        <div class="max-w-md w-full mx-auto px-4">
            ...
            <div class="bg-white rounded-3xl shadow-xl shadow-slate-200/50 border border-slate-200/60 overflow-hidden">
                ...
                <div class="bg-primary p-6 text-center text-white relative overflow-hidden">
                    ...
                    <h1 class="text-xl font-bold relative z-10 font-['Hanken_Grotesk']">Pembayaran Open Trip</h1>
                ...
                <div class="p-8">
                    ...
                    <div class="mb-6 pb-6 border-b border-dashed border-slate-200">
                        ...
                        <div class="flex flex-col gap-3 text-sm">
                            <div class="flex justify-between">
                                <span class="text-slate-500">Paket Trip</span>
                                <span class="font-semibold text-slate-800 text-right">{{ $order['trip_title'] }}</span>
                            </div>
                            <div class="flex justify-between">
                                <span class="text-slate-500">Ketua Rombongan</span>
                                <span class="font-semibold text-slate-800">{{ $order['penanggung_jawab'] }}</span>
                            </div>
                            <div class="flex justify-between">
                            ...
                            <div class="flex justify-between">
                                ...
                                <span class="font-bold text-primary">{{ $order['total_peserta'] }} Orang</span>
                            </div>

                            {{-- Daftar Anggota Rombongan --}}
                            @if (!empty($order['anggota']))
                                <div class="mt-3 pt-3 border-t border-slate-100 flex flex-col gap-2">
                                    <span class="text-[11px] font-bold text-slate-400 uppercase tracking-wider font-['JetBrains_Mono']">Daftar Anggota Rombongan</span>
                    ...
                    <div class="flex flex-col items-center justify-center mb-8">
                        <div class="w-48 h-48 bg-white border-2 border-slate-200 rounded-2xl p-4 flex items-center justify-center relative mb-4 shadow-sm shadow-slate-100">
                            ...
                            @else
                                <img src="https://api.qrserver.com/v1/create-qr-code/?size=150x150&data={{ urlencode('OPENTRIP_' . $order['trip_id'] . '_' . $order['penanggung_jawab']) }}" alt="QRIS Barcode" class="w-full h-full object-contain">
                    ...
                    <div class="p-4 bg-blue-50 text-blue-800 rounded-xl border border-blue-100 flex items-start gap-3 mb-6">
                        ...
                        <p class="text-xs leading-relaxed">
                            Setelah berhasil melakukan pembayaran, harap ambil tangkapan layar (screenshot) bukti transfer Anda. <strong>Kirimkan bukti tersebut ke WhatsApp admin</strong> untuk konfirmasi kuota grup.
                        </p>
                    </div>
                    ...
                    @php
                        ...
                        if (!empty($order['anggota'])) {
                            ...
                            . "%0A*Data Ketua Rombongan:*%0A"
                            . "- Nama: {$order['penanggung_jawab']}%0A"
                            . "- WhatsApp: {$order['whatsapp']}%0A";

                        if (!empty($itemLines)) {
                            $waMessage .= "%0A*Daftar Anggota Lain:*" . $itemLines . "%0A";
                        }
